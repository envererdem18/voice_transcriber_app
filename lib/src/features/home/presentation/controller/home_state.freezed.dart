...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Locale? locale, String? transcribedText});
}
...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({this.locale, this.transcribedText});
  ...
  @override
  String toString() {
    return 'HomeState(locale: $locale, transcribedText: $transcribedText)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, locale, transcribedText);
...
abstract class _HomeState implements HomeState {
  const factory _HomeState(
      {final Locale? locale, final String? transcribedText}) = _$HomeStateImpl;
